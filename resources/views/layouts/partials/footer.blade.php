    ...
    <div class="container footer-top">
        <div class="row gy-4">
            <div class="col-lg-5 col-md-12 footer-about">
                ...
                <p>Petir Logistik membantu kebutuhan pengiriman dan distribusi barang dengan mengutamakan pelayanan,
                    ketepatan proses, dan kemudahan bagi pelanggan.</p>
            ...
            <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
                ...
                <p><strong>Email:</strong> <span>info@petirlogistik.com</span></p>
            </div>
